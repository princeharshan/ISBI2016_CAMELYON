...
def generate_possible_patches(xml_file):
  ...
  for bounding_box in aggregated_boxes:
    if bounding_box[0] < 256 or bounding_box[1] < 256:
      print bounding_box
...
if __name__=='__main__':
  ...
  xml_files = glob.glob('/data/pathology/CAMELYON16/TrainingData/Ground_Truth/XML/*.xml')
  #print xml_files
  for xml_file in xml_files:
    generate_possible_patches(xml_file)
